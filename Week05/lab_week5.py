...
if not input_invalid:
  ...
  @        ..@#% @     @&*#@(         % 
   &   (  @    (   / /   *    @  .   /  
    ...
    loot_options, belt = functions_lab05_solution.collect_loot(loot_options, belt)
    print("    ------------------------------------------------------------------")
    print("    |", end="    ")
    ...
    loot_options, health_points = functions_lab05_solution.use_loot(belt, health_points)
    ...
    while input_invalid and tries in range(5):
        ...
        if len(name) != 2:
            print("    |    Pleas enter a name with two parts(separated by a space)")
            tries += 1
        else:
